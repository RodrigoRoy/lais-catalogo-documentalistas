<template>
    ...
    <div class="h-dvh w-5/6 sm:w-3/5 mx-6 sm:mx-12">
        <div>
            ...
            <p v-if="data.colectivos" class="font-light">
                Participó en: {{ data.colectivos }}
            </p>
            <p class="my-6">
                {{ data.semblanza }}
            </p>
            <div>
                <UButton v-if="data.clipVideo" variant="soft" size="md" icon="i-mdi-youtube" :to="data.clipVideo" target="_blank">Seminario Bitácora</UButton>
            </div>
        </div>
    </div>
    ...
    <UContainer>
        ...
        <div class="text-center">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-3">
                <div v-for="documental in data.documentales">
